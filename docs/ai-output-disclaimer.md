...
This document sets out the limits of responsibility for Marc ("the App"). It is
...
- **"App"**: the Marc client, its proxy, and the materials in this repository.
...
- The App captures microphone audio, relays it to a OpenAI Realtime call, and
  renders what comes back as an egg.
